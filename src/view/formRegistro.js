...
export default function FormRegistroComponent() {
                        ...
                        <form>
                            <div className="card mb-4">
                                <div className="row form-position padding_form">
                                    ...
                                    <h6 className="titulo-termos form-subtitulo">Confirme os seus dados pessoais</h6>
                                        ...
                                        <div className="card-position">
                                            <div className="row g-3 row-width">
                                                ...
                                                <div className="col-md-4">
                                                    <label htmlFor="exampleFormControlInput1" className="form-label form-space fs-6 form-texto">
                                                        Primeiro Nome
                                                    </label>
                                                    <input type="text" className="form-control" placeholder="eg. Michael" aria-label="First name" value={campName} onChange={(value) =>
                                                ...
                                                <div className="col-md-4">
                                                    ...
                                                    <input type="text" className="form-control" placeholder="eg. Prior" aria-label="Último Nome"
                                                        value={campPassword} onChange={(value) =>
                                    ...
                                    <h4 className="titulo-termos form-titulo">Diga-nos os seus dados de morada</h4>

                                    <div className="row card-position">
                                        <div className="col-8">
                                            <div className="mb-3">
                                                <label htmlFor="exampleFormControlInput1" className="form-label fs-6 form-texto form-space">
                                                    Código-Postal
                                                </label>
                                                <input
                                                    type="text"
                                                    ...
                                                    pattern="^\d{4}-\d{3}?$"
                                                    value={campCodigoPostal} onChange={(value) =>
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <input
                                                    ...
                                                    value={campAddress} onChange={(value) =>
                                            ...
                                            <div className="row g-3">
                                                ...
                                                <div className="col">
                                                    ...
                                                    <input
                                                        ...
                                                        aria-describedby="inputGroup-sizing-sm"
                                                        placeholder="eg. Bloco b1, apartamento 5D"
                                                        value={campDistrito} onChange={(value) =>
                                    ...
                                    <h4 className="titulo-termos form-titulo">Qual o seu tipo de produção?</h4>

                                    <div className="row card-position mx-auto card_energia">
                                        <div className="card-body card_energia2">
                                            <div className="pagar d-flex producao-align">
                                            ...
                                            <div className="pagar d-flex producao-align">
                                                <div className="pagamento">
                                                    ...
                                                    <h6 className="text-center">Outra</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-6 text-end btn-guardar-avancar">
                                    ...
                                    <Link to="/fimRegistro">
                                        <button className="btn bg-gradient-dark mb-0 btn-color" type="submit"
                                            onClick={() => SendSave()}>
                                            Guardar
                                        </button>
                                    </Link>
    ...
    function SendSave() {
        if (selectRole === 0) {
            ...
            alert("Escolha um Email")
        }
        else if (campPassword === "") {
            alert("Escolha sua palavra-chave")
        }
        else {
            const baseUrl = "http://localhost:3000/User/create"
            const datapost = {
                name: campName,
                email: campEmail,
