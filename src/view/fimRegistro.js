    ...
    <main className="main-content mt-0">
      <section>
        <div
          ...
          style={{ backgroundImage: `url(${imageFundoTurbo})` }}
        >
              ...
              <div className="col-xl-5 col-lg-5 col-md-7 d-flex flex-column mx-auto">
                <div className="card z-index-0">
                  <div className="card card-plain">
                    <div className="card-header pb-0 text-start d-flex flex-column align-items-center">
                      <h4 className="font-weight-bolder text-center">
                        OBRIGADO POR SE REGISTAR!
                      </h4>
                      <p className="mb-0 text-center mt-5">
                        Um e-mail de verificação foi enviado para a sua caixa de
                        entrada.
                      </p>
                      <Link to="/">
                        <button
                          type="button"
                          className="btn btn-primary btn-pay mt-2"
                        >
